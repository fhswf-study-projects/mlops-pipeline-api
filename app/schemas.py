...
class UserInputRequest(BaseModel):
    age: float = Field(
        ..., ge=16, le=91, description="How old are you? Accepted age: 16-91"
    )
    workclass: Literal[
        "Private",
        "Local-gov",
    ...
    education: Literal[
        ...
        "1st-4th",
        "Preschool",
    ] = Field(..., description="Select your highest education-level archieved.")
    ...
    occupation: Literal[
        ...
        "Handlers-cleaners",
        "Armed-Forces",
    ] = Field(..., description="Select your general type of occupation.")
    relationship: Literal[
        "Own-child", "Husband", "Not-in-family", "Unmarried", "Wife", "Other-relative"
    ] = Field(..., description="Select your relationship.")
    race: Literal[
    ...
    capital_gain: float = Field(
        ...
        ge=0,
        le=100000,
        description="Insert your capital gain.0-100.000",
    ...
    capital_loss: float = Field(
        ...
        ge=0,
        le=5000,
        description="Insert your capital loss. 0-5.000",
    ...
    hours_per_week: int = Field(
        ...
        ge=0,
        le=65,
        description="Insert your hours per week you work at. 1-65",
    ...
    native_country: Literal[
        ...
        ...,
        description="Insert your country of origin.",
        serialization_alias="native-country",
    )
